...
# import grpc
# import pandas as pd
# from pykujira.orderhash import OrderHashResponse
# from pykujira.proto.exchange.kujira_accounts_rpc_pb2 import (
#     StreamSubaccountBalanceResponse,
#     SubaccountBalance,
#     SubaccountDeposit as Account_SubaccountDeposit,
# )
# from pykujira.proto.exchange.kujira_explorer_rpc_pb2 import (
#     CosmosCoin,
#     GasFee,
...
#     TxDetailData,
# )
# from pykujira.proto.exchange.kujira_portfolio_rpc_pb2 import (
...
#     SubaccountDeposit,
# )
# from pykujira.proto.exchange.kujira_spot_exchange_rpc_pb2 import (
#     MarketsResponse,
#     OrderbookResponse,
...
#
#         self.kujira_async_client_mock_patch = patch(
#             target=(
#                 "hummingbot.connector.gateway.clob_spot.data_sources.kujira.kujira_api_data_source.AsyncClient"
#             ),
#             autospec=True,
#         )
#         self.kujira_async_client_mock: Optional[AsyncMock] = None
#         self.gateway_instance_mock_patch = patch(
#             target=(
#                 "hummingbot.connector.gateway.clob_spot.data_sources.kujira.kujira_api_data_source"
#                 ".GatewayHttpClient"
#             ),
#             autospec=True,
#         )
#         self.gateway_instance_mock: Optional[AsyncMock] = None
#         self.kujira_order_hash_manager_start_patch = patch(
#             target=(
#                 "hummingbot.connector.gateway.clob_spot.data_sources.kujira.kujira_api_data_source"
...
#             autospec=True,
#         )
#         self.kujira_composer_patch = patch(
#             target="hummingbot.connector.gateway.clob_spot.data_sources.kujira.kujira_api_data_source"
#                    ".ProtoMsgComposer",
#             autospec=True,
#         )
#         self.kujira_compute_order_hashes_patch = patch(
#             target=(
#                 "hummingbot.connector.gateway.clob_spot.data_sources.kujira.kujira_api_data_source"
...
#             autospec=True,
#         )
#         self.kujira_compute_order_hashes_mock: Optional[AsyncMock] = None
#
...
#
#     def start(self):
#         self.kujira_async_client_mock = self.kujira_async_client_mock_patch.start()
#         self.kujira_async_client_mock.return_value = self.kujira_async_client_mock
...
#         self.kujira_order_hash_manager_start_patch.start()
#         self.kujira_composer_patch.start()
#         self.kujira_compute_order_hashes_mock = self.kujira_compute_order_hashes_patch.start()
#
#         self.kujira_async_client_mock.stream_spot_trades.return_value = StreamMock()
#         self.kujira_async_client_mock.stream_historical_spot_orders.return_value = StreamMock()
#         self.kujira_async_client_mock.stream_spot_orderbooks.return_value = StreamMock()
#         self.kujira_async_client_mock.stream_account_portfolio.return_value = StreamMock()
#         self.kujira_async_client_mock.stream_subaccount_balance.return_value = StreamMock()
#         self.kujira_async_client_mock.stream_txs.return_value = StreamMock()
#
#         self.configure_active_spot_markets_response(timestamp=self.initial_timestamp)
#
#     def stop(self):
#         self.kujira_async_client_mock_patch.stop()
#         self.gateway_instance_mock_patch.stop()
#         self.kujira_order_hash_manager_start_patch.stop()
#         self.kujira_composer_patch.stop()
#         self.kujira_compute_order_hashes_patch.stop()
#
#     def run_until_all_items_delivered(self, timeout: float = 1):
#         self.kujira_async_client_mock.stream_spot_trades.return_value.run_until_all_items_delivered(timeout=timeout)
#         self.kujira_async_client_mock.stream_historical_spot_orders.return_value.run_until_all_items_delivered(
#             timeout=timeout
#         )
#         self.kujira_async_client_mock.stream_spot_orderbooks.return_value.run_until_all_items_delivered(
#             timeout=timeout
#         )
#         self.kujira_async_client_mock.stream_subaccount_balance.return_value.run_until_all_items_delivered(
#             timeout=timeout
#         )
#         self.kujira_async_client_mock.stream_txs.return_value.run_until_all_items_delivered(
#             timeout=timeout
#         )
#
...
#             )
#         self.kujira_compute_order_hashes_mock.return_value = OrderHashResponse(
...
#         self.kujira_async_client_mock.ping.side_effect = None
#
#     def configure_check_network_failure(self, exc: Type[Exception] = grpc.RpcError):
#         self.kujira_async_client_mock.ping.side_effect = exc
#
...
#
#         if self.kujira_async_client_mock.get_spot_trades.side_effect is None:
#             self.kujira_async_client_mock.get_spot_trades.side_effect = [trades, TradesResponse()]
#         else:
#             self.kujira_async_client_mock.get_spot_trades.side_effect = (
#                 list(self.kujira_async_client_mock.get_spot_trades.side_effect) + [trades, TradesResponse()]
#             )
#
...
#         self.kujira_async_client_mock.get_spot_trades.side_effect = RuntimeError
#
...
#         self.kujira_async_client_mock.stream_spot_trades.return_value.add(maker_trade_response)
#         self.kujira_async_client_mock.stream_spot_trades.return_value.add(taker_trade_response)
#
...
#         )
#         self.kujira_async_client_mock.stream_subaccount_balance.return_value.add(balance_event)
#
...
#
#         self.kujira_async_client_mock.get_spot_trades.return_value = trades
#
...
#
#         self.kujira_async_client_mock.get_spot_orderbook.return_value = orderbook_response
#
...
#         )
#
#         self.kujira_async_client_mock.stream_spot_orderbooks.return_value.add(orderbook_response)
#
...
#             timestamp=timestamp_ms,
#         )
#         self.kujira_async_client_mock.stream_historical_spot_orders.return_value.add(order_response)
#
...
#         self.kujira_async_client_mock.get_historical_spot_orders.return_value = mock_response
#
...
#
#         self.kujira_async_client_mock.get_account_portfolio.return_value = AccountPortfolioResponse(portfolio=portfolio)
#
...
#         data_data = "\n\275\001\n0/kujira.exchange.v1beta1.MsgBatchUpdateOrders"
...
#         messages_data = [
#             {
#                 'type': '/kujira.exchange.v1beta1.MsgBatchUpdateOrders',
#                 'value': {
#                     'order': {
#                         'market_id': self.market_id,
#                         'order_info': {
...
#         )
#         self.kujira_async_client_mock.get_tx_by_hash.return_value = GetTxByTxHashResponse(data=data)
#
...
#         transaction_hash: str = "",
#     ):
#         data_data = "\n0\n./kujira.exchange.v1beta1.MsgCancelSpotOrder"
...
#         messages_data = [
#             {
#                 'type': '/kujira.exchange.v1beta1.MsgCancelSpotOrder',
#                 'value': {
#                     'market_id': self.market_id,
#                     "order_hash": order_hash,
#                     'sender': 'inj1hkhdaj2a2clmq5jq6mspsggqs32vynpk228q3r',
...
#             tx_number=135726991,
#         )
#         self.kujira_async_client_mock.stream_txs.return_value.add(transaction_event)
#
...
#
#         self.kujira_async_client_mock.get_spot_markets.return_value = markets
