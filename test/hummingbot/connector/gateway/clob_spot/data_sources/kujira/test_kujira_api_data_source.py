...
#     PlaceOrderResult,
# )
# from hummingbot.connector.gateway.clob_spot.data_sources.kujira.kujira_api_data_source import (
#     KujiraAPIDataSource,
# )
...
#         self.kujira_async_client_mock = KujiraClientMock(
#             initial_timestamp=self.initial_timestamp,
#             sub_account_id=self.sub_account_id,
#             base=self.base,
#             quote=self.quote,
#         )
#         self.kujira_async_client_mock.start()
#
...
#         self.kujira_async_client_mock.stop()
...
#         self.kujira_async_client_mock.configure_place_order_response(
...
#         self.kujira_async_client_mock.configure_batch_order_create_response(
#             timestamp=self.initial_timestamp,
#             transaction_hash=expected_transaction_hash,
...
#         self.kujira_async_client_mock.configure_cancel_order_response(
#             timestamp=self.initial_timestamp, transaction_hash=expected_transaction_hash
#         )
#         self.kujira_async_client_mock.configure_get_historical_spot_orders_response_for_in_flight_order(
#             timestamp=self.initial_timestamp,
...
#
#         self.kujira_async_client_mock.run_until_all_items_delivered()
#
...
#         self.kujira_async_client_mock.configure_batch_order_cancel_response(
#             timestamp=self.initial_timestamp,
#             transaction_hash=expected_transaction_hash,
...
#         self.assertIn(self.kujira_async_client_mock.market_id, symbol_map)
...
#         self.kujira_async_client_mock.configure_spot_trades_response_to_request_without_exchange_order_id(
#             timestamp=self.initial_timestamp,
#             price=target_price,
#             size=Decimal("0.001"),
...
#         self.kujira_async_client_mock.configure_orderbook_snapshot(
...
#         self.kujira_async_client_mock.configure_trade_stream_event(
#             timestamp=self.initial_timestamp,
#             price=target_price,
#             size=target_size,
#             maker_fee=target_maker_fee,
...
#         self.kujira_async_client_mock.configure_order_stream_event(
#             timestamp=self.initial_timestamp,
...
#         self.kujira_async_client_mock.configure_get_account_balances_response(
...
#         )
#         self.kujira_async_client_mock.configure_get_historical_spot_orders_response(
...
#             direction="sell",
#         )
#         self.kujira_async_client_mock.configure_trades_response_with_exchange_order_id(
...
#         self.kujira_async_client_mock.configure_check_network_failure()
#
...
#
#         self.kujira_async_client_mock.configure_check_network_success()
#
#         status = self.async_run_with_timeout(coro=self.data_source.check_network_status())
#
...
#
#         service_provider_rebate = Decimal("1") - self.kujira_async_client_mock.service_provider_fee
#         expected_maker_fee = self.kujira_async_client_mock.maker_fee_rate * service_provider_rebate
...
#         self.kujira_async_client_mock.configure_account_base_balance_stream_event(
#             timestamp=self.initial_timestamp,
...
#         self.kujira_async_client_mock.configure_creation_transaction_stream_event(
...
#         )
#         self.tracker.start_tracking_order(order=in_flight_order)
#         self.kujira_async_client_mock.configure_order_status_update_response(
#             timestamp=self.initial_timestamp,
...
#         self.kujira_async_client_mock.configure_cancelation_transaction_stream_event(
#             timestamp=self.initial_timestamp + 1,
