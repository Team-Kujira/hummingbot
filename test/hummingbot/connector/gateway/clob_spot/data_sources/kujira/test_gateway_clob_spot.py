...
#         self.clob_data_source_mock = KujiraClientMock(
...
#         }
#         api_data_source = KujiraAPIDataSource(
...
#         self.assertEqual(Decimal("-0.00006"), fee.percent)  # factoring in Kujira service-provider rebate
#
#         fee = self.exchange.get_fee(
#             base_currency=self.base_asset,
#             quote_currency=self.quote_asset,
