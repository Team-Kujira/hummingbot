...
class Route(Enum):
    ...
    GET_ORDER_BOOK = (HTTPMethod.GET.value[0], 'order/book'),
    GET_ORDER_BOOKS = (HTTPMethod.GET.value[0], 'order/books'),
    GET_ORDER_BOOKS_ALL = (HTTPMethod.GET.value[0], 'order/books/all'),
    ...
    DELETE_ORDER = (HTTPMethod.DELETE.value[0], 'order'),
    DELETE_ORDERS = (HTTPMethod.DELETE.value[0], 'orders'),
    DELETE_ORDERS_ALL = (HTTPMethod.DELETE.value[0], 'orders/all'),
    ...
    GET_WALLET_PUBLIC_KEY = (HTTPMethod.GET.value[0], 'wallet/public/key'),
    GET_WALLET_PUBLIC_KEYS = (HTTPMethod.GET.value[0], 'wallet/public/keys'),
